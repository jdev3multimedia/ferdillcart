...
Smartly or Earn. ',
  ...
  'google_analytics' => 'Google analytics',
  'Please_ensure_you_have_filled_in_the_Google analytics_script_ID.' => 'Please ensure you have filled in the Google analytics script ID.',
  'analytic_script_updated_successfully' => 'Analytic script updated successfully',
  'google_tag_manager' => 'Google tag manager',
  'Please_ensure_you_have_filled_in_the_Google tag manager_script_ID.' => 'Please ensure you have filled in the Google tag manager script ID.',
  ...
  'Gateway image is required' => 'Gateway image is required',
  'Gateway image size should not be greater than 2048MB' => 'Gateway image size should not be greater than 2048MB',
  'Gateway image must be a jpeg,jpg,png,gif,webp' => 'Gateway image must be a jpeg,jpg,png,gif,webp',
  'Api Key is required when payment status is ON' => 'Api Key is required when payment status is ON',
